...
#*******Peut etre a supprimer en dessous*****************
# def test_ajouter_et_supprimer_livre():
#     b = Bibliotheque()
#     livre = b.ajouter_livre("1984", "George Orwell")
#     assert b.nombre_total_livres() == 1
#
#     # suppression réussie si disponible
#     assert b.supprimer_livre(livre.id)
#     assert b.nombre_total_livres() == 0
#
# def test_supprimer_livre_emprunte():
#     b = Bibliotheque()
#     livre = b.ajouter_livre("Le Petit Prince", "Antoine de Saint-Exupéry")
#     u = b.creer_utilisateur("Alice")
#     b.emprunter(u.id, livre.id)
#     with pytest.raises(ValueError):
#         b.supprimer_livre(livre.id)
#
# def test_emprunter_et_rendre():
#     b = Bibliotheque()
#     livre = b.ajouter_livre("Python", "Jean Dupont")
#     u = b.creer_utilisateur("Bob")
#
#     b.emprunter(u.id, livre.id)
#     assert livre.status == "emprunté"
#     assert livre.id in u.livres_empruntes
#
#     b.rendre(u.id, livre.id)
...
#     b = Bibliotheque()
#     u = b.creer_utilisateur("Alice")
#     # suppression OK si aucun emprunt
#     assert b.supprimer_utilisateur(u.id)
#
# def test_supprimer_utilisateur_avec_emprunt():
#     b = Bibliotheque()
#     u = b.creer_utilisateur("Alice")
#     livre = b.ajouter_livre("1984", "George Orwell")
#     b.emprunter(u.id, livre.id)
#     with pytest.raises(ValueError):
#         b.supprimer_utilisateur(u.id)
#
# def test_recherches_livres():
#     b = Bibliotheque()
#     l1 = b.ajouter_livre("Le Petit Prince", "Saint-Exupéry")
#     l2 = b.ajouter_livre("1984", "George Orwell")
#
#     assert b.rechercher_par_titre("petit") == [l1]
#     assert b.rechercher_par_auteur("Orwell") == [l2]
#     assert b.rechercher_par_mot_clef("prince") == [l1]
#
# def test_statistiques():
#     b = Bibliotheque()
#     l1 = b.ajouter_livre("Livre1", "A")
#     l2 = b.ajouter_livre("Livre2", "B")
#     u1 = b.creer_utilisateur("Alice")
#     u2 = b.creer_utilisateur("Bob")
#     b.emprunter(u1.id, l1.id)
#     b.emprunter(u2.id, l2.id)
#
#     dist = b.distribution_emprunts_par_utilisateur()
#     assert dist[u1.id] == 1
#     assert dist[u2.id] == 1
#
#     histo = b.histogramme_emprunts()
#     # 0 emprunt : 0 utilisateurs ?
#     assert histo[1] == 2
